...
def test_create_user(test_app, monkeypatch):
    test_request_payload = {"username": "michal", "password": "some_password", "email": "michal.kalita@gmail.com"}
    test_response_payload = {"id": 1, "username": "michal", "password": "some_password",
                             "email": "michal.kalita@gmail.com"}

    async def mock_post(_payload):
        return 1
